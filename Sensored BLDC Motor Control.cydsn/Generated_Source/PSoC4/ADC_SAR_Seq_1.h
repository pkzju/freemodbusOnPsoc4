...
#define ADC_SAR_Seq_1_DEFAULT_VREF_SEL               (6u)
#define ADC_SAR_Seq_1_DEFAULT_NEG_INPUT_SEL          (1u)
...
#define ADC_SAR_Seq_1_DEFAULT_SE_RESULT_FORMAT_SEL   (0u)
#define ADC_SAR_Seq_1_DEFAULT_CLOCK_SOURCE           (1u)
#define ADC_SAR_Seq_1_DEFAULT_VREF_MV_VALUE          (1650)
