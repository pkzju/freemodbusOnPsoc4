...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        G_LED_PC =   (G_LED_PC & \
                                (uint32)(~(uint32)(G_LED_DRIVE_MODE_IND_MASK << (G_LED_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (G_LED_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  G_LED_DM_STRONG     Strong Drive 
*  G_LED_DM_OD_HI      Open Drain, Drives High 
*  G_LED_DM_OD_LO      Open Drain, Drives Low 
*  G_LED_DM_RES_UP     Resistive Pull Up 
*  G_LED_DM_RES_DWN    Resistive Pull Down 
*  G_LED_DM_RES_UPDWN  Resistive Pull Up/Down 
*  G_LED_DM_DIG_HIZ    High Impedance Digital 
*  G_LED_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(G_LED__0__SHIFT, mode);
}
