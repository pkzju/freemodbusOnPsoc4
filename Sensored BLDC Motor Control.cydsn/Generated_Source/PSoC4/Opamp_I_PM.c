...
#if(!Opamp_I_CHECK_DEEPSLEEP_SUPPORT)
    static Opamp_I_BACKUP_STRUCT Opamp_I_backup =
    {
        0u, /* enableState */
    };
#endif /* (Opamp_I_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: Opamp_I_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Opamp_I_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
*
* Global variables:
*  Opamp_I_backup: The structure field 'enableState' is modified
...
{
#if(!Opamp_I_CHECK_DEEPSLEEP_SUPPORT)
    if(Opamp_I_CHECK_PWR_MODE_OFF)
    {
        Opamp_I_backup.enableState = 1u;
        Opamp_I_Stop();
    }
    else /* The component is disabled */
    {
        Opamp_I_backup.enableState = 0u;
    }
#endif /* (Opamp_I_CHECK_DEEPSLEEP_SUPPORT) */
}
...
*
* Global variables:
*  Opamp_I_backup: The structure field 'enableState' is used to
...
{
#if(!Opamp_I_CHECK_DEEPSLEEP_SUPPORT)
    if(0u != Opamp_I_backup.enableState)
    {
