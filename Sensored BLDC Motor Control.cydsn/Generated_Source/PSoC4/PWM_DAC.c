...
*   Values:
*     - PWM_DAC_CMD_CAPTURE    - Trigger Capture command
*     - PWM_DAC_CMD_RELOAD     - Trigger Reload command
*     - PWM_DAC_CMD_STOP       - Trigger Stop command
*     - PWM_DAC_CMD_START      - Trigger Start command
*
* Return:
*  None
*
