...
#define PWM_DAC_PWM_DEAD_TIME_CYCLE            (40lu)
...
/* Interrupt Mask */
#define PWM_DAC_PWM_INTERRUPT_MASK             (0lu)
...
/* PWM Mode */
#define PWM_DAC_PWM_PERIOD_VALUE               (3000lu)
#define PWM_DAC_PWM_PERIOD_BUF_VALUE           (4096lu)
#define PWM_DAC_PWM_PERIOD_SWAP                (0lu)
#define PWM_DAC_PWM_COMPARE_VALUE              (1500lu)
#define PWM_DAC_PWM_COMPARE_BUF_VALUE          (1999lu)
