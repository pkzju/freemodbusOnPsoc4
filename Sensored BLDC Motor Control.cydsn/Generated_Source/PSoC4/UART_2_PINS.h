...
#define UART_2_REMOVE_SCLK_PIN      (1u)
#define UART_2_REMOVE_SS0_PIN      (1u)
...
#define UART_2_REMOVE_UART_RX_PIN             (0u)
...
#define UART_2_SCLK_PIN     (0u == UART_2_REMOVE_SCLK_PIN)
#define UART_2_SS0_PIN     (0u == UART_2_REMOVE_SS0_PIN)
...
#if (UART_2_SCLK_PIN)
    #include "UART_2_spi_sclk.h"
#endif /* (UART_2_SCLK) */

#if (UART_2_SS0_PIN)
    #include "UART_2_spi_ss0.h"
...
***************************************/
...
#if (UART_2_RX_WAKE_SCL_MOSI_PIN)
    #define UART_2_RX_WAKE_SCL_MOSI_HSIOM_REG \
                            (*(reg32 *) UART_2_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define UART_2_RX_WAKE_SCL_MOSI_HSIOM_PTR \
                            ( (reg32 *) UART_2_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define UART_2_RX_WAKE_SCL_MOSI_HSIOM_MASK \
                            (UART_2_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define UART_2_RX_WAKE_SCL_MOSI_HSIOM_POS \
                            (UART_2_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)

    #define UART_2_RX_WAKE_SCL_MOSI_INTCFG_REG \
                            (*(reg32 *) UART_2_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define UART_2_RX_WAKE_SCL_MOSI_INTCFG_PTR \
                            ( (reg32 *) UART_2_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define UART_2_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (UART_2_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define UART_2_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK \
                            ((uint32) UART_2_INTCFG_TYPE_MASK << \
...
#if (UART_2_SCLK_PIN)
    #define UART_2_SCLK_HSIOM_REG   (*(reg32 *) UART_2_spi_sclk__0__HSIOM)
    #define UART_2_SCLK_HSIOM_PTR   ( (reg32 *) UART_2_spi_sclk__0__HSIOM)
    #define UART_2_SCLK_HSIOM_MASK  (UART_2_spi_sclk__0__HSIOM_MASK)
    #define UART_2_SCLK_HSIOM_POS   (UART_2_spi_sclk__0__HSIOM_SHIFT)
#endif /* (UART_2_SCLK_PIN) */

#if (UART_2_SS0_PIN)
    #define UART_2_SS0_HSIOM_REG   (*(reg32 *) UART_2_spi_ss0__0__HSIOM)
    #define UART_2_SS0_HSIOM_PTR   ( (reg32 *) UART_2_spi_ss0__0__HSIOM)
    #define UART_2_SS0_HSIOM_MASK  (UART_2_spi_ss0__0__HSIOM_MASK)
    #define UART_2_SS0_HSIOM_POS   (UART_2_spi_ss0__0__HSIOM_SHIFT)
#endif /* (UART_2_SS0_PIN) */
    ...
    #define UART_2_TX_HSIOM_PTR   ( (reg32 *) UART_2_tx_0__HSIOM)
...
#define UART_2_SCLK_PIN_INDEX       (2u)
#define UART_2_SS0_PIN_INDEX       (3u)
...
#define UART_2_SCLK_PIN_MASK     ((uint32) 0x01u << UART_2_SCLK_PIN_INDEX)
#define UART_2_SS0_PIN_MASK     ((uint32) 0x01u << UART_2_SS0_PIN_INDEX)
...
#if (UART_2_SS0_PIN)
    #define UART_2_CHECK_SS0_PIN_USED \
                (UART_2_PIN_DM_ALG_HIZ != \
                    UART_2_GET_P4_PIN_DM(UART_2_spi_ss0_PC, \
                                                   UART_2_spi_ss0_SHIFT))
#endif /* (UART_2_SS0_PIN) */
...
#define UART_2_REMOVE_SCLK_PIN                UART_2_REMOVE_SCLK_PIN
#endif /* UART_2_REMOVE_SCLK_PIN */
#ifndef UART_2_REMOVE_SS0_PIN
#define UART_2_REMOVE_SS0_PIN                 UART_2_REMOVE_SS0_PIN
...
#define UART_2_SCLK_PIN               UART_2_SCLK_PIN
#endif /* UART_2_SCLK_PIN */
#ifndef UART_2_SS0_PIN
#define UART_2_SS0_PIN                UART_2_SS0_PIN
#endif /* UART_2_SS0_PIN */
    ...
    #define UART_2_SCLK_HSIOM_REG     UART_2_SCLK_HSIOM_REG
    #define UART_2_SCLK_HSIOM_PTR     UART_2_SCLK_HSIOM_PTR
    #define UART_2_SCLK_HSIOM_MASK    UART_2_SCLK_HSIOM_MASK
    #define UART_2_SCLK_HSIOM_POS     UART_2_SCLK_HSIOM_POS
    #endif /* UART_2_SCLK_HSIOM_REG */
#endif /* (UART_2_SCLK_PIN) */

#if (UART_2_SS0_PIN)
    #ifndef UART_2_SS0_HSIOM_REG
    #define UART_2_SS0_HSIOM_REG      UART_2_SS0_HSIOM_REG
    #define UART_2_SS0_HSIOM_PTR      UART_2_SS0_HSIOM_PTR
    #define UART_2_SS0_HSIOM_MASK     UART_2_SS0_HSIOM_MASK
    #define UART_2_SS0_HSIOM_POS      UART_2_SS0_HSIOM_POS
...
#define UART_2_SCLK_PIN_INDEX             UART_2_SCLK_PIN_INDEX
#endif /* UART_2_SCLK_PIN_INDEX */
#ifndef UART_2_SS0_PIN_INDEX
#define UART_2_SS0_PIN_INDEX              UART_2_SS0_PIN_INDEX
...
#define UART_2_SCLK_PIN_MASK             UART_2_SCLK_PIN_MASK
#endif /* UART_2_SCLK_PIN_MASK */
#ifndef UART_2_SS0_PIN_MASK
#define UART_2_SS0_PIN_MASK              UART_2_SS0_PIN_MASK
