...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Vrpm_PC =   (Vrpm_PC & \
                                (uint32)(~(uint32)(Vrpm_DRIVE_MODE_IND_MASK << (Vrpm_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Vrpm_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  Vrpm_DM_STRONG     Strong Drive 
*  Vrpm_DM_OD_HI      Open Drain, Drives High 
*  Vrpm_DM_OD_LO      Open Drain, Drives Low 
*  Vrpm_DM_RES_UP     Resistive Pull Up 
*  Vrpm_DM_RES_DWN    Resistive Pull Down 
*  Vrpm_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Vrpm_DM_DIG_HIZ    High Impedance Digital 
*  Vrpm_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(Vrpm__0__SHIFT, mode);
}
...
*  
* Note:
*  Macro Vrpm_ReadPS calls this function. 
*  
*******************************************************************************/
