// ======================================================================
// Sensored BLDC Motor Control.v generated from TopDesign.cysch
// 05/27/2016 at 20:44
...
`else
`define CY_BLK_DIR "D:\PSoC\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "D:\PSoC\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
`else
`define CY_BLK_DIR "D:\PSoC\PSoC Creator\3.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Timer_v2_70"
`include "D:\PSoC\PSoC Creator\3.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Timer_v2_70\B_Timer_v2_70.v"
`endif

// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC4, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=81, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=17, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_1, CY_INSTANCE_SHORT_NAME=Timer_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=Timer_1, )
...
`else
`define CY_BLK_DIR "D:\PSoC\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "D:\PSoC\PSoC Creator\3.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
module SCB_P4_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("5e918f71-cb3f-4054-80d7-c4e38d922b34/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5e918f71-cb3f-4054-80d7-c4e38d922b34/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5e918f71-cb3f-4054-80d7-c4e38d922b34/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__B_LED_net;
	wire [0:0] tmpFB_0__B_LED_net;
	wire [0:0] tmpIO_0__B_LED_net;
	wire [0:0] tmpINTERRUPT_0__B_LED_net;
	electrical [0:0] tmpSIOVREF__B_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("4dfc7600-dcf9-42a9-809b-9754146f12db"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		B_LED
		 (.oe(tmpOE__B_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_LED_net[0:0]}),
		  .io({tmpIO_0__B_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__B_LED_net),
		  .interrupt({tmpINTERRUPT_0__B_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__G_LED_net;
	wire [0:0] tmpFB_0__G_LED_net;
	wire [0:0] tmpIO_0__G_LED_net;
	wire [0:0] tmpINTERRUPT_0__G_LED_net;
	electrical [0:0] tmpSIOVREF__G_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("85951983-6ed7-4aef-8e3d-189f0925e385"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		G_LED
		 (.oe(tmpOE__G_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__G_LED_net[0:0]}),
		  .io({tmpIO_0__G_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__G_LED_net),
		  .interrupt({tmpINTERRUPT_0__G_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__G_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__R_LED_net;
	wire [0:0] tmpFB_0__R_LED_net;
	wire [0:0] tmpIO_0__R_LED_net;
	wire [0:0] tmpINTERRUPT_0__R_LED_net;
	electrical [0:0] tmpSIOVREF__R_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("dd6bc061-bb49-4d02-a70d-62eca06a8b03"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		R_LED
		 (.oe(tmpOE__R_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__R_LED_net[0:0]}),
		  .io({tmpIO_0__R_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__R_LED_net),
		  .interrupt({tmpINTERRUPT_0__R_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__R_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    SCB_P4_v3_0_1 UART_2 (
        .interrupt(Net_10995),
        .clock(1'b0),
        .rx_tr_out(Net_10997),
        .tx_tr_out(Net_10998));

	wire [0:0] tmpOE__RE_net;
	wire [0:0] tmpFB_0__RE_net;
	wire [0:0] tmpIO_0__RE_net;
	wire [0:0] tmpINTERRUPT_0__RE_net;
	electrical [0:0] tmpSIOVREF__RE_net;

	cy_psoc3_pins_v1_10
		#(.id("42fa841e-675d-4d0e-83c1-d5721261ec62"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		RE
		 (.oe(tmpOE__RE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RE_net[0:0]}),
		  .io({tmpIO_0__RE_net[0:0]}),
		  .siovref(tmpSIOVREF__RE_net),
		  .interrupt({tmpINTERRUPT_0__RE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
