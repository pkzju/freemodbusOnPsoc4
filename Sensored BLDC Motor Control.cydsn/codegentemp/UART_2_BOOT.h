...
/* Enable UART bootloader communication */
       ...
       #define UART_2_UART_BTLDR_COMM_ENABLED    (UART_2_BTLDR_COMM_ENABLED && \
                                                            (UART_2_SCB_MODE_UNCONFIG_CONST_CFG || \
                                                             (UART_2_UART_RX_DIRECTION && \
                                                              UART_2_UART_TX_DIRECTION)))
#else
...
***************************************/
    ...
    /* Map I2C specific bootloader communication APIs to SCB specific APIs */
        ...
        #define UART_2_CyBtldrCommStart   UART_2_I2CCyBtldrCommStart
        #define UART_2_CyBtldrCommStop    UART_2_I2CCyBtldrCommStop
        #define UART_2_CyBtldrCommReset   UART_2_I2CCyBtldrCommReset
        #define UART_2_CyBtldrCommRead    UART_2_I2CCyBtldrCommRead
        #define UART_2_CyBtldrCommWrite   UART_2_I2CCyBtldrCommWrite
    ...
    #if (UART_2_SCB_MODE_EZI2C_CONST_CFG)
        #define UART_2_CyBtldrCommStart   UART_2_EzI2CCyBtldrCommStart
        #define UART_2_CyBtldrCommStop    UART_2_EzI2CCyBtldrCommStop
        #define UART_2_CyBtldrCommReset   UART_2_EzI2CCyBtldrCommReset
        #define UART_2_CyBtldrCommRead    UART_2_EzI2CCyBtldrCommRead
        #define UART_2_CyBtldrCommWrite   UART_2_EzI2CCyBtldrCommWrite
    #endif /* (UART_2_SCB_MODE_EZI2C_CONST_CFG) */
    ...
    /* Map SPI specific bootloader communication APIs to SCB specific APIs */
        ...
        #define UART_2_CyBtldrCommStart   UART_2_SpiCyBtldrCommStart
        #define UART_2_CyBtldrCommStop    UART_2_SpiCyBtldrCommStop
        #define UART_2_CyBtldrCommReset   UART_2_SpiCyBtldrCommReset
        #define UART_2_CyBtldrCommRead    UART_2_SpiCyBtldrCommRead
        #define UART_2_CyBtldrCommWrite   UART_2_SpiCyBtldrCommWrite
    ...
    /* Map UART specific bootloader communication APIs to SCB specific APIs */
        ...
        #define UART_2_CyBtldrCommStart   UART_2_UartCyBtldrCommStart
        #define UART_2_CyBtldrCommStop    UART_2_UartCyBtldrCommStop
        #define UART_2_CyBtldrCommReset   UART_2_UartCyBtldrCommReset
        #define UART_2_CyBtldrCommRead    UART_2_UartCyBtldrCommRead
        #define UART_2_CyBtldrCommWrite   UART_2_UartCyBtldrCommWrite
...
#define UART_2_BYTES_TO_COPY(actBufSize, bufSize) \
...
*/
#ifndef UART_2_SPI_BYTE_TO_BYTE
    #define UART_2_SPI_BYTE_TO_BYTE   (160u)
#endif

/* Byte to byte time interval: calculated basing on current component
* baud rate configuration, can be defined in the project if required.
*/
#ifndef UART_2_UART_BYTE_TO_BYTE
    #define UART_2_UART_BYTE_TO_BYTE  (2086u)
#endif /* UART_2_UART_BYTE_TO_BYTE */
